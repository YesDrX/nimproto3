...
proc fromBinary*(T: typedesc[Multiple_import_common_CommonType],
    data: openArray[byte]): Multiple_import_common_CommonType
proc toJson*(self: Multiple_import_common_CommonType): JsonNode
proc fromJson*(T: typedesc[Multiple_import_common_CommonType],
    node: JsonNode): Multiple_import_common_CommonType

proc toBinary*(self: Multiple_import_1_TypeMultipleImport1): seq[byte]
proc fromBinary*(T: typedesc[Multiple_import_1_TypeMultipleImport1],
    data: openArray[byte]): Multiple_import_1_TypeMultipleImport1
proc toJson*(self: Multiple_import_1_TypeMultipleImport1): JsonNode
proc fromJson*(T: typedesc[Multiple_import_1_TypeMultipleImport1],
    node: JsonNode): Multiple_import_1_TypeMultipleImport1

proc toBinary*(self: Multiple_import_2_TypeMultipleImport2): seq[byte]
proc fromBinary*(T: typedesc[Multiple_import_2_TypeMultipleImport2],
    data: openArray[byte]): Multiple_import_2_TypeMultipleImport2
proc toJson*(self: Multiple_import_2_TypeMultipleImport2): JsonNode
proc fromJson*(T: typedesc[Multiple_import_2_TypeMultipleImport2],
    node: JsonNode): Multiple_import_2_TypeMultipleImport2

proc toBinary*(self: MultipleImport): seq[byte]
proc fromBinary*(T: typedesc[MultipleImport], data: openArray[
    byte]): MultipleImport
...
proc fromBinary*(T: typedesc[Multiple_import_1_TypeMultipleImport1_EnumMultipleImport1],
    data: openArray[
    byte]): Multiple_import_1_TypeMultipleImport1_EnumMultipleImport1 =
  var pos = 0
  result = Multiple_import_1_TypeMultipleImport1_EnumMultipleImport1(
      decodeInt32(data, pos))

proc toJson*(self: Multiple_import_1_TypeMultipleImport1_EnumMultipleImport1): JsonNode =
  result = %int(self)

proc fromJson*(T: typedesc[Multiple_import_1_TypeMultipleImport1_EnumMultipleImport1],
    node: JsonNode): Multiple_import_1_TypeMultipleImport1_EnumMultipleImport1 =
  result = Multiple_import_1_TypeMultipleImport1_EnumMultipleImport1(
      node.getInt())
...
proc fromBinary*(T: typedesc[Multiple_import_1_TypeMultipleImport1],
  ...
  while pos < data.len:
    ...
    of 2:
      let fieldData = decodeLengthDelimited(data, pos)
      result.enumMultipleImport1 = fromBinary(
          Multiple_import_1_TypeMultipleImport1_EnumMultipleImport1, fieldData)
    else:
      discard
...
proc fromJson*(T: typedesc[Multiple_import_1_TypeMultipleImport1],
  ...
  if node.hasKey("enumMultipleImport1"):
    result.enumMultipleImport1 = fromJson(
        Multiple_import_1_TypeMultipleImport1_EnumMultipleImport1, node["enumMultipleImport1"])
...
proc fromBinary*(T: typedesc[MultipleImport], data: openArray[
  ...
  while pos < data.len:
    ...
    of 1:
      let fieldData = decodeLengthDelimited(data, pos)
      result.fldFromMultipleImport1 = fromBinary(
          Multiple_import_1_TypeMultipleImport1, fieldData)
    of 2:
      let fieldData = decodeLengthDelimited(data, pos)
      result.fldFromMultipleImport2 = fromBinary(
          Multiple_import_2_TypeMultipleImport2, fieldData)
    else:
      discard
...
proc fromJson*(T: typedesc[MultipleImport], node: JsonNode): MultipleImport =
  ...
  if node.hasKey("fldFromMultipleImport1"):
    result.fldFromMultipleImport1 = fromJson(
        Multiple_import_1_TypeMultipleImport1, node["fldFromMultipleImport1"])
  if node.hasKey("fldFromMultipleImport2"):
    result.fldFromMultipleImport2 = fromJson(
        Multiple_import_2_TypeMultipleImport2, node["fldFromMultipleImport2"])
